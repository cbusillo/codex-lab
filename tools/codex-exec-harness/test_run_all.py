...
def expected_scenario_total() -> int:
    """Count scenarios `run_all.py` is expected to sweep."""
...
class RunAllReportTest(unittest.TestCase):
    def test_main_writes_aggregate_report(self) -> None:
        ...
        summaries = {
            "background-review-same-turn-commit": {
                "scenario": "background-review-same-turn-commit",
                "passed": True,
                "returncode": 0,
                "token_usage": {
                    "input_tokens": 10,
            ...
            "provider-routing-high-risk-external": {
                "scenario": "provider-routing-high-risk-external",
                "passed": True,
                "returncode": 0,
                "token_usage": {
                    "input_tokens": 20,
            ...
            "third-party-agent-current-binary-lifecycle": {
                "scenario": "third-party-agent-current-binary-lifecycle",
                "passed": True,
                "returncode": 0,
                "token_usage": {
                    "input_tokens": 280,
