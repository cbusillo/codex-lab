...
Codex Lab tracks OpenAI Codex updates as immutable audit waves. Adding an audit or ledger records evidence and decisions; it does not import upstream code.
