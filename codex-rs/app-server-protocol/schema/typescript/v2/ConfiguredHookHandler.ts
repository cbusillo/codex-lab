...
export type ConfiguredHookHandler = { "type": "command",
/**
 ...
 */
id: string | null, command: string, commandWindows: string | null, timeoutSec: bigint | null, async: boolean, statusMessage: string | null,
/**
