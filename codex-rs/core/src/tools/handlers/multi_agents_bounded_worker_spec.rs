...
pub(super) fn bounded_worker_input_schema() -> JsonSchema {
    serde_json::from_value(json!({
        ...
        "properties": {
            ...
            "max_result_bytes": {"type": "integer", "description": "Retained final result/diagnostic limit, 256..8192 UTF-8 bytes. Larger results retain a marked tail; this does not cap all subprocess output."},
            "context": {"anyOf": [
