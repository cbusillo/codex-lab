...
use crate::agent::user_agent_intent::record_user_agent_mentions;
...
pub(crate) async fn run_turn(
    ...
    record_user_agent_mentions(turn_context.extension_data.as_ref(), &user_input);
    ...
    loop {
        ...
        record_user_agent_mentions(turn_context.extension_data.as_ref(), &pending_user_input);
