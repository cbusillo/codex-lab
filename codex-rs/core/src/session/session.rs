...
pub(crate) struct SessionConfiguration {
    ...
    pub(super) session_provenance: Option<codex_protocol::protocol::SessionProvenance>,
...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        .await;
        let control_models_manager = models_manager;
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let services = SessionServices {
                ...
                execution_account: execution_account.clone(),
            ...
            services
                .model_client
                .set_execution_account_lease(execution_account);
