...
pub(super) async fn prepare_review_thread(
    ...
    let initial_settings = Arc::new(ResolvedStepSettings::new(
        Arc::new(StepSettings {
            collaboration_mode: CollaborationMode {
                mode: parent_turn_context.mode,
                settings: Settings {
                    model: model.clone(),
                    reasoning_effort: reasoning_effort.clone(),
                    developer_instructions: parent_turn_context
                        .collaboration_mode_developer_instructions
                        .clone(),
                },
            },
            reasoning_summary: per_turn_config.model_reasoning_summary,
            service_tier: per_turn_config.service_tier.clone(),
            personality: parent_turn_context.personality,
            approval_policy: per_turn_config.permissions.approval_policy.clone(),
            approvals_reviewer: per_turn_config.approvals_reviewer,
        }),
    ...
    let use_model_token_budget_defaults = per_turn_config.features.enabled(Feature::TokenBudget)
    ...
    let review_turn_context = TurnContext {
        ...
        personality: parent_turn_context.personality,
        cyber_access_program: parent_turn_context.cyber_access_program,
