...
impl OAuthStoreLock {
    ...
    fn acquire_with_timeout(
        ...
        // authority. Those stores are CODEX_LAB_HOME-backed today: if CODEX_LAB_HOME is unset they use
...
pub(super) enum OAuthStoreLockFailure {
    #[error("failed to resolve CODEX_LAB_HOME for MCP OAuth {store} aggregate-store lock")]
    CodexHome {
        store: OAuthStore,
        #[source]
        source: io::Error,
